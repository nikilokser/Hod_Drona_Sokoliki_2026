...
`VOTE_MAX_ATTEMPTS=3`, `VOTE_SUBPROCESS_TIMEOUT_SEC=8`,
`VOTE_RETRY_DELAY_SEC=0.5` - худший случай ~25 с (изначально было 13/1 -
~41 с; таймаут короткий намеренно, см. комментарий в коде: реальный ответ
